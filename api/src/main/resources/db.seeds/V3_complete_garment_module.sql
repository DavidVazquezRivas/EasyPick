...
UPDATE garments SET warmth_index = 2, preference_score = 8 WHERE name = 'Camiseta Básica';
UPDATE garments SET warmth_index = 4, preference_score = 9 WHERE name = 'Vaqueros Slim';
UPDATE garments SET warmth_index = 8, preference_score = 5 WHERE name = 'Chaqueta Anuncio';
...
INSERT INTO colors (id, name, hex_code) VALUES
    ('11111111-1111-1111-1111-111111111111', 'Blanco', '#FFFFFF'),
...
SELECT id, '11111111-1111-1111-1111-111111111111' FROM garments WHERE name = 'Camiseta Básica';

INSERT INTO garment_colors (garment_id, color_id)
SELECT id, '22222222-2222-2222-2222-222222222222' FROM garments WHERE name = 'Vaqueros Slim';

INSERT INTO garment_colors (garment_id, color_id)
SELECT id, '33333333-3333-3333-3333-333333333333' FROM garments WHERE name = 'Chaqueta Anuncio';

-- Insert Brands (We let the database generate the UUIDs automatically)
INSERT INTO brands (name) VALUES
    ('Zara'), ('H&M'), ('Mango'), ('Pull&Bear'), ('Bershka'), ('Stradivarius'), ('Massimo Dutti'), ('Uniqlo'), ('Primark'), ('ASOS'), ('Shein'),
    ('Nike'), ('Adidas'), ('Puma'), ('Under Armour'), ('Reebok'), ('New Balance'), ('Asics'), ('Fila'),
    ('Lee'), ('Wrangler'), ('Vans'), ('Converse'), ('Diesel'), ('Pepe Jeans'),
    ('Ralph Lauren'), ('Tommy Hilfiger'), ('Calvin Klein'), ('Lacoste'), ('Hugo Boss'), ('Guess'),
    ('The North Face'), ('Patagonia'), ('Columbia'), ('Timberland'),
    ('Sin Marca'), ('Hecho a mano');
...
INSERT INTO categories (name, description) VALUES
    ('Camisetas', 'Prendas ligeras para la parte superior, manga corta o larga'),
