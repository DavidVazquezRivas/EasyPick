...
const DEFAULT_BACKDROP_TINT = 'rgba(0, 0, 0, 0.8)'
...
const withStringFallback = (value: string | null | undefined, fallback: string) => value ?? fallback
...
export const GlobalModalHost = ({
  ...
  const resolvedBackdropTint = withStringFallback(backdropTint, DEFAULT_BACKDROP_TINT)
